...
class Users extends Seeder
{
    ...
    {
        $users = [
        ["name"=>"admin","email"=>"admin@mail.local","email_verified_at"=>NULL,"password"=>"\$2y\$10\$hPECG6dj/Wx3eI0pf3WrXesLXIzkQHFGZskM9WDfa9pWMt/pxOKYa","api_token"=>NULL,"created_at"=>"2020-05-05 06:19:00","updated_at"=>"2020-05-05 06:19:00","isAdmin"=>TRUE,"isBanned"=>FALSE],
